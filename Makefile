...
help:
	...
	@echo "  results/figures/fig2_ridgeline_nhsn_seasons_by_agegroup.pdf"
	@echo "  results/figures/fig2_ridgeline_nssp_seasons.pdf"
	@echo "  results/figures/nssp_fig3_infant_ppx_realistic_delivery_fractional_protection.pdf"
	@echo "  results/figures/nhsn_fig3_infant_ppx_realistic_delivery_fractional_protection.pdf"
	@echo "  results/figures/combined_infant_ppx_stress_test_window_gains.pdf"
	@echo "  results/figures/nssp_infant_ppx_hospitalizations_averted_early_vs_baseline.pdf"
	@echo "  results/figures/nssp_infant_ppx_hospitalizations_averted_late_vs_baseline.pdf"
	@echo "  results/figures/nssp_infant_ppx_hospitalizations_averted_extended_vs_baseline.pdf"
